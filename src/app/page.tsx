  ...
  return (
    <main className='flex min-h-screen flex-col items-center'>
      <div className='my-auto flex flex-col gap-4 max-w-sm'>
        ...
        <section className='flex flex-col gap-4 font-light text-sm leading-relaxed text-neutral-300'>
          ...
          <div>
            I&apos;m also a part-time grad student at{' '}
            <LinkButton
              ...
              imgDimTw='w-3 h-3.5'
            />
            , focusing on software systems and machine learning.
          </div>

          <p>
            Before software, I primarily worked in strategic finance, where I
            helped bring an e-commerce startup{' '}
            <LinkText
              text='public'
